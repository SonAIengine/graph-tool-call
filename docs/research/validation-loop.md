...
`/tmp/gtc-bfcl-028-gate-full-qwen.json`은 gate `fail`이다. Retrieved exact@5
mean은 `0.865`로 target `0.87`에 근접했지만, retrieval@5 `0.953`, row-source
preservation `0.904497`, `parallel_multiple` exact@5 `0.730`이 threshold를
...
Failure inspector summary: 91 failure cases, 169 expected tool mentions,
