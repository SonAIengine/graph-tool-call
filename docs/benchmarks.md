...
For paper claims and the frozen experiment protocol, see
[`docs/research/paper-readiness-design.md`](research/paper-readiness-design.md).
...
> **Release-claim policy:** the `v0.45.1` README headline uses the checked-in,
> model-free [dependency-chain release artifact](../benchmarks/results/releases/v0.45.1/dependency-chain-evidence.json).
...
events. The current
[observability artifact](../benchmarks/results/releases/v0.45.1/observability-evidence.json)
