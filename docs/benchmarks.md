...
> **Release-claim policy:** the `v0.40.0` README headline uses the checked-in,
> model-free [dependency-chain release artifact](../benchmarks/results/releases/v0.40.0/dependency-chain-evidence.json).
