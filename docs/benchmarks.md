...
> **Release-claim policy:** the `v0.46.0` README headline uses the checked-in,
> model-free [dependency-chain release artifact](../benchmarks/results/releases/v0.46.0/dependency-chain-evidence.json).
...
events. The current
[observability artifact](../benchmarks/results/releases/v0.46.0/observability-evidence.json)
