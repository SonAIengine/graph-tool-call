...
hard-case bundle run improved deterministic `recall@5` from `0.9325` to
`0.94025`, `all_tools_found@5` from `0.908` to `0.917`, and reduced hard cases
from `92` to `83`. This is not a BFCL leaderboard/model score; it is the fast
