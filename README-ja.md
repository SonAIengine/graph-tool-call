...
| API | ツール数 | ツールの渡し方 | 精度 | Recall@5 |
|-----|:-----:|-------------|:----:|:--------:|
| Petstore | 19 | 全19件（フィルタなし） | 100% | — |
| GitHub | 50 | 全50件（フィルタなし） | 100% | — |
| MCP Servers | 38 | 全38件（フィルタなし） | 96.7% | — |
| **Kubernetes** | **248** | **全248件（フィルタなし）** | **12%** | — |
| | | **graph-tool-callが上位5件を選別** | **78%** | **91%** |
| | | **+ エンベディング** | **80%** | **94%** |
| | | **+ オントロジー** | **82%** | **96%** |
| | | **+ 両方** | **82%** | **98%** |
