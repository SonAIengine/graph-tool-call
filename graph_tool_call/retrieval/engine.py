...
class RetrievalEngine:
    ...
    def _preserve_dominant_keyword_candidates(
        ...
        *,
        ...
        keyword_by_name = dict(ranked_keyword[:10])
        final_rank_by_name = {name: rank for rank, (name, _score) in enumerate(ranked_final)}
        top_keyword_name, _top_keyword_score = ranked_keyword[0]
        top_final_name, top_final_score = ranked_final[0]
        if (
            allow_top_rank_promotion
            and top_keyword_name != top_final_name
