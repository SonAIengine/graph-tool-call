...
- **50개 미만**: LLM이 전체 tool을 줘도 잘 고름. graph-tool-call 가치 = **64–88% 토큰 절감**.
- **248개**: 전체를 주면 LLM이 **12%로 붕괴**. graph-tool-call로 필터링하면 **82%** — 최적화가 아니라 **필수**.

<details>
<summary>Kubernetes 상세: pipeline별 정확도 & Recall@5</summary>
